...
compiler crash therefore cannot corrupt the Tiga runtime process.
"""
...
def _serve() -> int:
    ...
    for line in sys.stdin:
        try:
            ...
            with TemporaryDirectory(prefix="tiga-worker-ttir-") as directory:
...
_WORKER = PersistentCompileWorker(
    timeout_seconds=float(os.environ.get("TIGA_COMPILE_TIMEOUT_SECONDS", "300"))
)
