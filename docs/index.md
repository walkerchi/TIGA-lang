...
| Dynamic radius | generated Euclidean cell traversal, periodic boxes/skew cells, build–consume fusion | custom unbounded metrics use the semantic fallback; exact kNN ranked lowering remains partial |
